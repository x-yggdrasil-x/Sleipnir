...
In order to support loading of multiple wallets in odin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is odin.cpp.
...
Changes to odin.cpp
----------------------
odin.cpp is the entry point into odin-qt, and as such, will require some minor modifications to provide hooks for

...
PIVX Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zPIVX protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
- #294 `27c0943` Add additional checks for txid for zPIVX spend. (presstab)
- #301 `b8392cd` Refactor zPIVX tx counting code. Add a final check in ConnectBlock() (presstab)
...
- #327 `aa1235a` [Main] Don't limit zPIVX spends from getting into the mempool (Fuzzbawls)
...
### GUI
- #309 `f560ffc` [UI] Better error message when too much inputs are used for spending zPIVX (Mrs-X)

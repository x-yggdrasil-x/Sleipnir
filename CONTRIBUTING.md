Contributing to ODIN Core
============================

The ODIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ODIN Core project, and is not to be
confused with overall ODIN Network Protocol consensus changes.

Whether a pull request is merged into ODIN Core rests with the project merge
...
Patches that change ODIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the ODIN consensus, it must have been
...
The project leader is the release manager for each ODIN Core release.

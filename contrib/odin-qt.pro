...
RESOURCES += src/qt/odin.qrc src/qt/odin_locale.qrc

TRANSLATIONS += src/qt/locale/odin_bg.ts \
                src/qt/locale/odin_de.ts \
                src/qt/locale/odin_en.ts \
                src/qt/locale/odin_es.ts \
                src/qt/locale/odin_fi.ts \
                src/qt/locale/odin_fr.ts \
                src/qt/locale/odin_it.ts \
                src/qt/locale/odin_ja.ts \
                src/qt/locale/odin_pl.ts \
                src/qt/locale/odin_pt.ts \
                src/qt/locale/odin_ru.ts \
                src/qt/locale/odin_sk.ts \
                src/qt/locale/odin_sv.ts \
                src/qt/locale/odin_vi.ts \
                src/qt/locale/odin_zh_CN.ts \
                src/qt/locale/odin_zh_TW.ts

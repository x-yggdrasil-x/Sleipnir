...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"odin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"odin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"odin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"odin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"odin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"odin", "masternodedebug", &masternodedebug, true, true, false},
        {"odin", "startmasternode", &startmasternode, true, true, false},
        {"odin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"odin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"odin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"odin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"odin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"odin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"odin", "mnbudget", &mnbudget, true, true, false},
        {"odin", "preparebudget", &preparebudget, true, true, false},
        {"odin", "submitbudget", &submitbudget, true, true, false},
        ...
        {"odin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"odin", "checkbudgets", &checkbudgets, true, true, false},
        {"odin", "mnsync", &mnsync, true, true, false},
        ...
        {"zerocoin", "getzodinseed", &getzodinseed, false, false, true},
        {"zerocoin", "setzodinseed", &setzodinseed, false, false, true}
...
{
    return "> odin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22100/\n";
}

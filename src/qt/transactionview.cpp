 ...
 */
    ...
    typeWidget->addItem(tr("Received ODIN from zODIN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zODIN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zODIN));
